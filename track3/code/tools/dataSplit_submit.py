...
if __name__ == '__main__':
    ...
    train_json_file = json_file.replace('ego_objects_challenge_train.json', 'ego_objects_challenge_trainSplit_submit.json')
    ...
    val_json_file = json_file.replace('ego_objects_challenge_train.json', 'ego_objects_challenge_valSplit_submit.json')
