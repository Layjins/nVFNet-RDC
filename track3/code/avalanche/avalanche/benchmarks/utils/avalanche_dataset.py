...
class AvalancheDataset(IDatasetWithTargets[T_co, TTargetType], Dataset[T_co]):
    ...
    def __getitem(self, idx) -> Union[T_co, Sequence[T_co]]:
        return TupleTLabel(
            manage_advanced_indexing(
    ...
    def evaluate(self,
        ...
        #self.cat_ids = self.categories_id_mapping
        #self.cat_ids = self.ego_api.get_cat_ids()
        ...
        #pdb.set_trace()
        #json.dump(json_results, open('./test.json', 'w'), indent=4)
