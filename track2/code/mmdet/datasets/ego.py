...
class EgoInsDetDataset(EgoCatDetDataset):
    ...
    def get_all_cats(self,ann_file):
         ...
         #ann_file = os.path.join(path,'ego_objects_challenge_valSplit_track2.json')
         ann_file = '/youtu/fuxi-team2-2/CLVision/track2_datasets/ego_objects_challenge_valSplit_track2.json'
         data = json.load(open(ann_file))
         images,annotations = data['images'],data['annotations']
         # get main_id
         main_ids = []
