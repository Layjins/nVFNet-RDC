...
class SingleStageDetector(BaseDetector):
    ...
    def __init__(self,
        ...
        # exp0
        train_anno_path_exp0 = DATASET_PATH + '/' + 'ego_objects_challenge_trainSplit_track2_exp0.json'
        ...
        # exp1
        train_anno_path_exp1 = DATASET_PATH + '/' + 'ego_objects_challenge_trainSplit_track2_exp1.json'
        ...
        # exp2
        train_anno_path_exp2 = DATASET_PATH + '/' + 'ego_objects_challenge_trainSplit_track2_exp2.json'
        ...
        # exp3
        train_anno_path_exp3 = DATASET_PATH + '/' + 'ego_objects_challenge_trainSplit_track2_exp3.json'
        ...
        # exp4
        train_anno_path_exp4 = DATASET_PATH + '/' + 'ego_objects_challenge_trainSplit_track2_exp4.json'
