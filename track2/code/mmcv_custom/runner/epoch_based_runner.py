    ...
    def run_iter(self, data_batch, train_mode, **kwargs):
        if self.batch_processor is not None:
            ...
            outputs = self.model.train_step(data_batch, self.optimizer, epoch=self.epoch,
                                  iter=self._inner_iter, teach=False, t_info=t_info, exp_id=self.exp_id,
                                  **kwargs)
        else:
...
class CustomRunner(CustomEpochBasedRunner):
    """Deprecated name of CustomEpochBasedRunner."""

    def __init__(self, *args, **kwargs):
        warnings.warn(
            'Runner was deprecated, please use CustomEpochBasedRunner instead')
