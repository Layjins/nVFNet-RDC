...
#DEFAULT_CHALLENGE_TRAIN_JSON = 'ego_objects_challenge_train.json' # better for track3
#DEFAULT_CHALLENGE_TEST_JSON = 'ego_objects_challenge_test.json'
DEFAULT_CHALLENGE_TRAIN_JSON = 'ego_objects_challenge_trainSplit_track2.json' # better for track2
DEFAULT_CHALLENGE_TEST_JSON = 'ego_objects_challenge_valSplit_track2.json'
#DEFAULT_CHALLENGE_TRAIN_JSON = 'ego_objects_challenge_trainSplit_73.json'
#DEFAULT_CHALLENGE_TEST_JSON = 'ego_objects_challenge_valSplit_73.json'
#DEFAULT_CHALLENGE_TRAIN_JSON = 'ego_objects_challenge_trainSplit_55.json'
#DEFAULT_CHALLENGE_TEST_JSON = 'ego_objects_challenge_valSplit_55.json'
