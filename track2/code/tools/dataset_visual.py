...
def main():
    import matplotlib
    matplotlib.use('Agg')
    sample_root: Path = '/youtu/fuxi-team2-2/CLVision/track2_datasets'
    vis_Path = '/youtu/fuxi-team2-2/CLVision/track2_datasets/vis_train/'
    ...
    #ego_vis = EgoObjectsVis(ego_api, img_dir=str(sample_root)+ '/' + 'cltest')
    ego_vis = EgoObjectsVis('/youtu/fuxi-team2-2/CLVision/track2_datasets/ego_objects_challenge_train.json', img_dir='/youtu/fuxi-team2-2/CLVision/track2_datasets/images')
