...
DEFAULT_CHALLENGE_TRAIN_JSON = 'ego_objects_challenge_trainSplit_track2.json'
DEFAULT_CHALLENGE_TEST_JSON = 'ego_objects_challenge_valSplit_track2.json'
...
def main():
    ...
    for experience in benchmark.train_stream:
        ...
        dataset_json_file = json_file.replace('.json', '_track3_exp' + str(exp_id)+'.json')
