...
if __name__ == '__main__':
    json_file = '/youtu/fuxi-team2-2/CLVision/track2_datasets/ego_objects_challenge_trainSplit_track2_exp0.json'
    sampled_img_num = 3500
    splited_json_path = '/youtu/fuxi-team2-2/CLVision/track2_datasets/ego_objects_challenge_trainSplit_track2_exp0_split.json'
