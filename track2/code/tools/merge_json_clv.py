...
if __name__ == "__main__":
    json_path1 = '/youtu/fuxi-team2-2/CLVision/track2_datasets/ego_objects_challenge_trainSplit_track2_exp0.json'
    json_path2 = '/youtu/fuxi-team2-2/CLVision/track2_datasets/ego_objects_challenge_trainSplit_track2_exp1.json'
    merged_json_path = '/youtu/fuxi-team2-2/CLVision/track2_datasets/ego_objects_challenge_trainSplit_track2_exp01.json'
